...
if True:
    ...
    packed_q_blocks_reshape = convert_weight_packed(q_blocks_reshape)
    output2 = fp8_scaled_mm_cpu(
        data, packed_q_blocks_reshape, scales_squeeze, scales_block_size, bias if has_bias else None, data.dtype, True
    )
else:
    # Per tensor
